...
export const telegramCopy = {
  ru: {
    ...
    alertThreshold: "Порог алерта за 24 ч (%)",
    alertThresholdHint: "Оставьте пустым, чтобы получать digest без порогового алерта.",
    language: "Язык",
    save: "Сохранить",
  ...
  en: {
    ...
    alertThreshold: "24h alert threshold (%)",
    alertThresholdHint: "Leave empty to receive the digest without threshold alerts.",
    language: "Language",
    save: "Save",
...
const pageCopy = {
  ru: {
    ...
    dashboard: {
      ...
      chartHint: "Наведите на область или коснитесь графика, чтобы увидеть общую стоимость и вклад источников.",
      sourceLegend: "Источники истории портфеля",
      onchain: "On-chain",
      cex: "CEX",
      manual: "Ручные",
  ...
  en: {
    ...
    dashboard: {
      ...
      chartHint: "Hover over an area or touch the chart to see total value and each source contribution.",
      sourceLegend: "Portfolio history sources",
      onchain: "On-chain",
      cex: "CEX",
      manual: "Manual",
